...
graph TD;
    ...
    generate_gene_tree-->sampling_trees["<b>Sample</b> a proportion <font color='red'><b>s</b></font> of the extant leaves of the trees"];
    ...
    reconcile_all_gene_trees-->proof_reconciliation["<b>Reconciliations done</b>, synthesize data in csv files and build dataset.pkl objects"];
